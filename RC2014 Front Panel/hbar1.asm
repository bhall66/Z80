...
;
;  Draw an animated horizontal bar on the front panel LCD
...
;
AnimateHBar:
    LD   A,ROW                 ; reset cursor location
    LD   B,COL                
    CALL GotoRC
    LD   C,D
